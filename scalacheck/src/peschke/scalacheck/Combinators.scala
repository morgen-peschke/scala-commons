...
/** Various common operations and [[Gen]] factories to make working with
  * [[org.scalacheck.Gen]] easier.
  *
  * Most of the time, bulk importing the members of
  * [[peschke.scalacheck.syntax]] gives better results.
  */
object Combinators {

  /** Similar to [[Gen.listOfN]], however the length of the list is generated
    * based on `range`, rather than a fixed value
    */
